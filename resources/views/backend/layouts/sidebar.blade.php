...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#testmonialCollapse" aria-expanded="true" aria-controls="aboutCollapse">
          <i class="fas fa-sitemap"></i>
          <span>TestMonial</span>
        </a>
        <div id="testmonialCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Testimonial Options:</h6>
            <a class="collapse-item" href="{{route('testmonial.index')}}">Testimonial</a>
            <a class="collapse-item" href="{{route('testmonial.create')}}">Add Testimonial</a>
          </div>
        </div>
    </li>
    <!-- Reviews -->
